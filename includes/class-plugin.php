...
final class Plugin {
	...
	public static function load() {
		...
		$diagnostic_queue = new Diagnostic_Queue( $diagnostics, $settings );
		...
		$diagnostic_queue->register_hooks();
		...
		if ( is_admin() ) {
			...
			$admin_diagnostics = new Admin_Diagnostics(
				$settings,
				$diagnostics,
				$resolver,
				$url,
