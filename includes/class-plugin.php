...
final class Plugin {
	...
	public static function load() {
		...
		$preview_api         = new Markdown_Preview_REST_Controller( $document, $settings, $resolver, $url );
		$llms_txt_controller = new Llms_Txt_Controller( $llms_txt );
		$discovery           = new Discovery( $resolver, $url );

		$controller->register_hooks();
		$preview_api->register_hooks();
	...
	public static function deactivate() {
		Upgrade::remove_legacy_diagnostic_queue();
		flush_rewrite_rules();
	}
}
