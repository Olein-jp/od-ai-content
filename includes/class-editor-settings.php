...
final class Editor_Settings {
	...
	public function enqueue_assets() {
		...
		wp_localize_script(
			...
			array(
				'dirtyNotice'          => __( 'Unsaved changes are not included in the preview. Save the post before generating a new preview.', 'od-ai-content' ),
				...
				'excludedBlocksTitle'  => __( 'Intentionally excluded blocks', 'od-ai-content' ),
				'fallbackBlocksTitle'  => __( 'Blocks using unverified HTML fallback', 'od-ai-content' ),
				...
				'previewError'         => __( 'The Markdown preview could not be generated.', 'od-ai-content' ),
				'previewLabel'         => __( 'Markdown preview', 'od-ai-content' ),
				'previewPath'          => '/od-ai-content/v1/posts/%d/preview',
				'previewTitle'         => __( 'Markdown preview and conversion report', 'od-ai-content' ),
				'runPreviewLabel'      => __( 'Generate Markdown preview', 'od-ai-content' ),
