...
require_once OD_AI_CONTENT_DIR . 'includes/class-admin-markdown.php';
...
require_once OD_AI_CONTENT_DIR . 'includes/class-markdown-preview-rest-controller.php';
require_once OD_AI_CONTENT_DIR . 'includes/class-upgrade.php';
